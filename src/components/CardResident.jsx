...
import "../Style/CardResident.css";

const CardResident = ({ endpoint }) => {
  const [resident, getResident] = useFetch(endpoint);
    ...
    <article className="resident">
      ...
      <section className="resident__body">
        ...
        <ul className="resident__stats">
          ...
          <li className="resident__stat__item">
            <span className="resident__stat__label">Origen</span>
            <span className="resident__stat__value">
              {resident?.origin.name}
            </span>
          </li>
          <li className="resident__stat__item">
            <span className="resident__stat__label">
